...
Replace all {{PLACEHOLDER}} values with your information:
  civic-connect     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  civic-connect             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/civic-connect/security/advisories/new)
...
- This repository (`hyperpolymath/civic-connect`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/civic-connect/security/advisories)
...
When using civic-connect, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/civic-connect/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/civic-connect/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/civic-connect/discussions) |
...
*Thank you for helping keep civic-connect and its users safe.* 🛡️
