...
[arabic]
. Navigate to
https://github.com/hyperpolymath/civic-connect/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/civic-connect/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/civic-connect/discussions[GitHub
Discussions]
...
_Thank you for helping keep civic-connect and its users safe._ 🛡️
