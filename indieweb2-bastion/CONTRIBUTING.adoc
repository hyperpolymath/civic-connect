...
Thank you for considering contributing to indieweb2-bastion! This multi-chain identity platform welcomes contributions across Solidity, Motoko, AffineScript, and infrastructure.
...
# AffineScript: just test-affinescript
...
* AffineScript 11.0.1+
* stapeln toolchain — cerro-torre, selur, vordr (for containers and local testnet)
...
1. **Pre-PR checklist:**
   ...
   - [ ] AffineScript formatted (`affinescript format`)
