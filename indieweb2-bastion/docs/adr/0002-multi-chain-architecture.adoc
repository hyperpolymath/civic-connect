...
**Frontend:** AffineScript 11.0.1 (compiles to JavaScript, WASM-capable)
...
* **Language:** AffineScript 11.0.1 (strong typing, WASM-capable)
...
* ⚠️ **Frontend:** AffineScript can compile to WASM (planned)
