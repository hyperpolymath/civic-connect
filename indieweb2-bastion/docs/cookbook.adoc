...
**Purpose:** Compile AffineScript to JavaScript

**What it does:**
* Runs `npx affinescript build`
* Compiles `.res` files to `.bs.js`

=== `just affinescript-clean`

**Purpose:** Clean AffineScript build artifacts
