...
1. **Private report** to j.d.a.jewell@open.ac.uk
...
|CPR-001 |Password Hashing |Argon2id (512 MiB / 8 iter / 4 lanes) — RFC 9106 |Required
|CPR-002 |General Hashing |SHAKE3-512 — FIPS 202 |Required
|CPR-003 |PQ Signatures |Dilithium5-AES / ML-DSA-87 — FIPS 204 |Required
|CPR-004 |PQ Key Exchange |Kyber-1024 / ML-KEM-1024 — FIPS 203 |Required
|CPR-005 |Classical Sigs (hybrid) |Ed448 + Dilithium5 — RFC 8032 + FIPS 204 |Required
|CPR-006 |Symmetric Encryption |XChaCha20-Poly1305 — RFC 8439 ext. |Required
|CPR-007 |Key Derivation |HKDF-SHAKE512 — RFC 5869 + FIPS 202 |Required
|CPR-008 |RNG |ChaCha20-DRBG — NIST SP 800-90A |Required
|CPR-009 |Database Hashing |BLAKE3 + SHAKE3-512 |Required
|CPR-010 |Protocol Stack |QUIC + HTTP/3 + IPv6 — RFC 9000/9114/8200 |Required
|CPR-011 |Accessibility |WCAG 2.3 AAA |Required
|CPR-012 |Fallback Signature |SPHINCS+ / SLH-DSA — FIPS 205 |Required
|CPR-013 |Formal Verification |Coq / Isabelle/HOL |Required
|CPR-014 |TLS |TLS 1.3 only — RFC 8446 |Required
|CPR-015 |Certificate Pinning |DANE-TLSA — RFC 6698 |Required
...
* **Ed25519** — Replaced by Ed448+Dilithium5 hybrid (deadline: 2026-06-01)
* **SHA-1 / MD5** — Broken, collision attacks demonstrated (immediate)
* **RSA** — Quantum-vulnerable, replaced by ML-DSA-87 (deadline: 2026-06-01)
* **X25519** — Replaced by Kyber-1024 / ML-KEM-1024 (deadline: 2026-06-01)
* **HKDF-SHA256** — Replaced by HKDF-SHAKE512 (deadline: 2026-06-01)
* **SHA-256** — Replaced by SHAKE3-512 and BLAKE3 (deadline: 2026-09-01)
* **HTTP/1.1** — Replaced by HTTP/3 over QUIC (deadline: 2026-06-01)
* **IPv4** — IPv6-only policy (deadline: 2026-09-01)
* **TLS 1.2** — TLS 1.3 only (immediate)
