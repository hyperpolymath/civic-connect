...
git clone <https://github/hyperpolymath/civic-connect.git> cd
civic-connect
...
toolbox create civic-connect-dev toolbox enter civic-connect-dev \#
...
civic-connect/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github/hyperpolymath/civic-connect/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github/hyperpolymath/civic-connect/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github/hyperpolymath/civic-connect/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github/hyperpolymath/civic-connect/labels/perimeter-3) — Community sandbox scope
