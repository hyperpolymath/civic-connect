...
This bootstraps dependencies (jq, capnproto, nickel, deno), validates Nickel policies, runs the AffineScript policy gate, and starts the GUI/PWA server on port 8443.
...
| AffineScript | Policy gate (9 validators), UI components
